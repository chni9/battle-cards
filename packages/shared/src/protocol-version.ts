 ...
 *
 * 35 → 36 (L63-02 / designer 2026-09-20): public `pendingSentences` on the
 * playing view; per-recipient `buyPoolCard` may omit `cardId` / `isUpgraded`.
 * Exception to the V6 single-bump lock (same class as L49 / L56 / L57 / L58 /
 * L60); see decisions.md.
 */
