 ...
 * (rules spec §5). Imposition no longer cedes lives (L63-04); `'imposition'`
 * remains on the union for old logs. Curse no longer causes life loss (L50-02 siphon). Damage never
