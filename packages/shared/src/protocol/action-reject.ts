...
export const ACTION_REJECT_MESSAGE: Record<ActionRejectCode, string> = {
  ...
  'ready-not-allowed': 'The host and bots do not ready.',
  'invalid-set-ready-payload': 'Invalid setReady payload.',
  'kick-not-host': 'Only the host can kick a player.',
  'kick-not-in-lobby': 'Kick is only used in the lobby.',
  'kick-self': 'You cannot kick yourself.',
  'kick-unknown': 'That seat was not found.',
  'invalid-kick-payload': 'Invalid kickPlayer payload.',
  'play-again-not-finished': 'Play again is only available after the game ends.',
  'play-again-tutorial': 'The tutorial cannot play again in this room.',
  'claim-not-claimable': 'That seat cannot be claimed.',
