...
**Three tasks remain blocked on a designer ruling** (L35-01, L36-03, L36-04). L34-01 / #V5-2 is
`Done` (unlimited shop). L32-01 is `Done` — golden rule 7 no longer instructs agents to refuse V5.
