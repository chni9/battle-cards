...
**Two tasks remain blocked on a designer ruling** (L36-03, L36-04). L33-05 and
L35-07 are `Blocked` on failed promotion gates (not open rulings) —
`DEFAULT_POLICY_ID` stays `heuristic-v4`. L34-01 / #V5-2 and L35-01 / #V5-1 are
closed. L32-01 is `Done` — golden rule 7 no longer instructs agents to refuse V5.
