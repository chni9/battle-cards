...
**Five tasks are blocked on a designer ruling, and one of them — L32-01 — blocks the other 38.**
Until golden rule 7 is rewritten, every agent session in this repo is under instruction to refuse
this work. That is the real critical path into V5, and it is not code.
