...
The flag and the `activateDuplication` action log are **Spy-gated** (designer 2026-08-06) —
not public on the view. Shield gains and Cloning resource assignment never enter the grant
wrappers.
