...
| **#V3-2** | ~~Does the client show *what* a bot decided, beyond the existing public log?~~ **Closed 2026-08-04:** public Why control on log rows with `botReason` (code+params). See `docs/agent/decisions.md`. | — | — |
...
| **#V3-4** | ~~Do the difficulty labels stay `easy` / `normal` / `hard`?~~ **Closed 2026-08-04:** wire ids unchanged; UI copy **Easy / Normal / Hard**. See `docs/agent/decisions.md`. | — | — |
