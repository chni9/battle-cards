...
export const HOW_TO_PLAY_SECTIONS: readonly HowToPlaySection[] = [
  {
    id: 'goal',
    title: 'Goal',
    body: "Last player alive wins. This is a turn-based elimination game for 2 to 8 players: reduce opponents' lives to 0 and stay alive yourself. Lives can never go above 25, no matter how you gain them.",
    screenshotFile: null,
  },
  {
    id: 'turn',
  ...
  },
  {
    id: 'shop',
    title: 'Shop',
    body: 'Open Shop to buy extra cards or upgrade points, a random pool card (others do not see which card you recovered), and to sell cards you do not need.',
