...
*Card Battle* is a turn-based elimination card game for 2 to 8 players, built on hidden
...
`docs/backlog_v6.md`); Lot 57 is the open feedback-conversion lot
(table `!` stays; Game over ask on every hub leave). V5 may continue in parallel. Audience: the designer
...
handler stay. **Lot 57** (designer 2026-09-14) converts existing feedback: every
finished match opens the Lot 47 ticket (Skip on hub leave); the table control
stays `!`. A bot playing badly is never grounds for touching a rule. **Search,
