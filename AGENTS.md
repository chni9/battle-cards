...
handler stay. **Lot 57** (designer 2026-09-14) converts existing feedback: ask-mode
is one sentence; every finished hub leave hits that ask; the table control stays
